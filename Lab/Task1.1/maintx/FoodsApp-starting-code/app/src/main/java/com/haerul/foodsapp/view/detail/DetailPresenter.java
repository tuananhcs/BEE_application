...
public class DetailPresenter {
    ...
    void getMealById(String mealName) {
        ...
        // #5 Call the void show loading before starting to make a request to the server
        view.showLoading();
        // #6 Make a request to the server (Don't forget to hide loading when the response is received)
