...
public class DetailActivity extends AppCompatActivity implements DetailView{ // #11  implement DetailView
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // #9 Get data from the intent
        Intent intent = getIntent();
        String mealName = intent.getStringExtra(EXTRA_DETAIL);
        // #10 Declare the presenter (put the name of the meal name from the data intent to the presenter)
